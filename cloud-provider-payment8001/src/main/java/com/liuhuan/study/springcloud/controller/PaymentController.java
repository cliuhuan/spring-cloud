...
public class PaymentController {
    ...
    public Object discovery() {
        ...
        for (ServiceInstance instance : instances) {
            log.info(instance.getServiceId() + "\t" + instance.getHost() + "\t" + instance.getPort() + "\t" + instance
                .getUri());
        }
    ...
    public String paymentZipkin() {
        return "hi ,i'am paymentzipkin server fall back，welcome to liuhuan's world，O(∩_∩)O哈哈~";
    }
}
